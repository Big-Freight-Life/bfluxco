 ...
 *
 * Resources library page - curated thinking tools for small and minority-owned businesses.
 * This replaces the previous blog layout.
 *
 * @package BFLUXCO
 */
...
<main id="main-content" class="site-main resources-page">

    <!-- Page Header -->
    <header class="page-header resources-header">
        <div class="container">
            <h1 class="page-title reveal-hero"><?php esc_html_e('Resources', 'bfluxco'); ?></h1>
    ...
    <!-- Filter Navigation -->
    <nav class="resources-nav reveal" data-delay="2">
        <div class="container">
            <div class="resources-tabs" role="tablist" aria-label="Resource categories">
                <button class="resources-tab is-active" role="tab" aria-selected="true" data-filter="all">
                    <?php esc_html_e('All Resources', 'bfluxco'); ?>
                </button>
                <button class="resources-tab" role="tab" aria-selected="false" data-filter="article">
                    <?php esc_html_e('Articles', 'bfluxco'); ?>
                </button>
                <button class="resources-tab" role="tab" aria-selected="false" data-filter="guide">
                    <?php esc_html_e('Guides', 'bfluxco'); ?>
                </button>
                <button class="resources-tab" role="tab" aria-selected="false" data-filter="framework">
                    <?php esc_html_e('Frameworks', 'bfluxco'); ?>
                </button>
                <button class="resources-tab" role="tab" aria-selected="false" data-filter="template">
                    <?php esc_html_e('Templates', 'bfluxco'); ?>
                </button>
                <button class="resources-tab" role="tab" aria-selected="false" data-filter="case-note">
                    <?php esc_html_e('Case Notes', 'bfluxco'); ?>
                </button>
            </div>
        </div>
    </nav>
